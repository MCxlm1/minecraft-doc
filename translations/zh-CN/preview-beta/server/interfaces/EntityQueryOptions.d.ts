...
export interface EntityQueryOptions extends EntityFilter {
    ...
    /**
     * @remarks
     * 向查询添加一个基准位置，该位置与最接近、最远、限制、体积和距离属性一起使用。
     *
     */
    location?: Vector3;
    /**
     * @remarks
     * 如果指定，则包含距离位置属性中指定位置小于此距离的实体。
     *
     */
    maxDistance?: number;
    /**
     * @remarks
     * 如果指定，则包含距离位置属性中指定位置至少为此距离的实体。
     *
     */
    minDistance?: number;
    /**
     * @remarks
     * 与位置结合使用，指定要包含的实体的长方体体积。
     *
     */
    volume?: Vector3;
}