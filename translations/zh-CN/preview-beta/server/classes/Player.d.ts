...
export class Player extends Entity {
     ...
     * @beta
     * @remarks
     * 玩家的聊天显示名称，由 {@link Player.chatNamePrefix} + {@link Player.name} + {@link Player.chatNameSuffix} 组成。
     * 这是此玩家发送的聊天消息中显示为作者的名字。
     * 要更改显示在玩家头顶上的名称，请使用 {@link Entity.nameTag}。
     *
     * @throws
     * 此属性在使用时可能抛出异常。
     *
     ...
     * @beta
     * @remarks
     * 一个可选字符串，设置后，会添加到此玩家发送的聊天消息文本之前。
     * 可用于将格式或颜色代码应用于玩家消息（例如，使用 '§a' 使消息变为绿色）。
     * 不影响玩家的名称显示——若要修改聊天中显示的名称，请使用 {@link Player.chatNamePrefix}；
     * 若要修改玩家头顶的名称，请使用 {@link Entity.nameTag}。设为 undefined 可清除。
     *
     ...
     * @beta
     * @remarks
     * 一个可选字符串，设置后，会在聊天消息中的玩家名称前添加前缀。
     * 不影响玩家头顶的名称标签或玩家列表——请使用 {@link Entity.nameTag}。
     * 若要为消息文本本身添加前缀，请使用 {@link Player.chatMessagePrefix}。设为 undefined 可清除。
     *
     * This property can't be edited in restricted-execution mode.
     *
     */
    ...
    /**
     * @remarks
     * 玩家是否正在跳跃。当玩家持续执行跳跃动作时，此值将保持为 true。
     *
     * @throws
     * 此属性在使用时可能抛出异常。
     */
    ...
    /**
     * @remarks
     * 对于此玩家，移除目标实体上所有实体属性的覆盖。此更改不会立即应用，直到下一个游戏刻，并且不会应用于其他玩家。
     *
     * This function can't be called in restricted-execution mode.
     *
     * @param targetEntity
     ...
     * @beta
     * @remarks
     * 吃一个物品，为玩家提供该物品的饥饿度和饱和度效果。只能用于食物物品。
     *
     * This function can't be called in restricted-execution mode.
     *
     * @param itemStack
    ...
    /**
     * @remarks
     * 排队播放一段额外的音乐曲目，只有该特定玩家能够听到。如果没有正在播放的曲目，则会播放一段音乐曲目。
     *
     * 此函数无法在受限执行模式下调用。
     *
     * @param trackId
    ...
    /**
     * @remarks
     * 对于该玩家，移除对实体属性的覆盖。此更改要到下一个游戏刻才会生效，并且不会应用于其他玩家。
     *
     * 此函数无法在受限执行模式下调用。
     *
     * @param targetEntity
    ...
    /**
     * @remarks
     * 设置玩家的控制方案。玩家的活动相机预设必须由脚本（如 camera.setCamera()）或命令设置。
     *
     * 此函数无法在受限执行模式下调用。
     *
     * @param controlScheme
     * 控制方案类型。如果此参数为 undefined，此方法会将玩家的控制方案清除回玩家相机的默认控制方案。
     * @returns
     * 如果控制方案成功添加或更新，则返回空值。如果玩家的当前相机不允许该控制方案，可能会抛出 InvalidArgumentError。
     * @throws 此函数可能抛出错误。
     *
     * {@link minecraftcommon.EngineError}
     *
    ...
    /**
     * @remarks
     * 对于该玩家，将目标实体上的实体属性覆盖为提供的值。此属性必须是客户端同步的。此更改要到下一个游戏刻才会生效，并且不会应用于其他玩家。
     *
     * 此函数无法在受限执行模式下调用。
     *
     * @param targetEntity
